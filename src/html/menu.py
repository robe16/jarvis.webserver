...
def html_menu(services):
    ...
    html += _html_menu_rhs()
    html += open(os.path.join(os.path.dirname(__file__), '../resources/html/common/menu_command_result.html'), 'r').read()
    return html
...
def _html_menu_lhs(services):
    ...
    if len(grouped_services) == 0:
        return open(os.path.join(os.path.dirname(__file__), '../resources/html/common/menu_lhs.html'), 'r').read().format(menu='')
    #
    for c in grouped_services.keys():
        ...
        for g in grouped_services[c].keys():
            ...
            try:
                ...
                #
                html += open(os.path.join(os.path.dirname(__file__), '../resources/html/common/menu_item.html'), 'r').read().format(**args)
                #
                #
            except:
                pass
    ...
    ################
    #
    return open(os.path.join(os.path.dirname(__file__), '../resources/html/common/menu_lhs.html'), 'r').read().format(menu=html)


def _html_menu_rhs():
    return open(os.path.join(os.path.dirname(__file__), '../resources/html/common/menu_rhs.html'), 'r').read().format(uri_servicestatus=uri_servicestatus)